...
# Deploy app
kubectl apply -f "app_and_HPA/deployment.yaml"
kubectl apply -f "app_and_HPA/service.yaml"
kubectl apply -f "app_and_HPA/hpa.yaml"
kubectl apply -f "app_and_HPA/metric-server.yaml"
